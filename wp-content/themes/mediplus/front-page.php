...
<section class="slider">
    <div class="hero-slider">
        <?php
            ...
            ?>
        <div class="single-slider" style="background-image:url('<?= esc_url($thumbnail_url[0]) ?>')">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="text">
                            ...
                            <div class="button">
                                <a href="#" class="btn">
                                    <?php
                                        $custom_fields = get_post_meta(get_the_ID(), 'button_1', true); 
                                        if($custom_fields) {
                                ...
                                <a href="#" class="btn primary">
                                    <?php
                                        $custom_fields_2 = get_post_meta(get_the_ID(), 'button_2', true); 
                                        if($custom_fields_2) {
                                            echo esc_html($custom_fields_2);
                                        }
                                    ?>
                                </a>
                            </div>
                ...
                <div class="single-news">
                    ...
                    <div class="news-body">
                        <div class="news-content">
                            <div class="date"><?php echo get_post_time('F j, Y') ?></div>
